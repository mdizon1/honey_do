...
ActiveRecord::Schema.define(version: 20160614210635) do
  ...
  add_index "tag_titles", ["title"], name: "tag_titles_title_idx", unique: true, using: :btree
  ...
  add_index "tags", ["taggable_id", "taggable_type", "tag_title_id"], name: "tags_join_idx", unique: true, using: :btree
