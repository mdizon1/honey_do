...
* Current
** TODO Sticky footer not working
* Backlog
...
** TODO Should show household name in app-bar
** TODO Make it clearer which list you're on
** TODO Shortcut for create new todo
** TODO Autofocus on todo title when opening new todo
