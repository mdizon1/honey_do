...
*** TODO Footer
    Needs design
*** TODO Create animated hero image
...
*** TODO Download/install section
    Button to bookmark. 
    For ios/android how to create a button to create a shortcut on the home 
    screen?
*** TODO Increase hover pop out behavior for cards
*** TODO Testimonials (optional)
* Backlog
** TODO After creating a todo, subsequent todos get same notes by default :bug:
   Possibly the new todo form isn't being cleared/reset
** TODO User should be able to edit a todo they create
** TODO Fix rendering of placeholder dragged todo
...
** TODO Flash alert needs a higher z index
