...
** TODO Tagging todo not working server side
   ...
   for tags..
** TODO Handle tags in forms client side as well
* Backlog
** TODO Make specs pass
** TODO app doesn't fix perfectly on phone
...
** TODO Determine whether to use font awesome or material icons
   And go with one only
